<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="social-shares">
		...
		<a class="social-share-link" href="https://plus.google.com/share?url=<?php echo urlencode(get_permalink()); ?>" target="_blank" rel="noreferrer noopener" aria-label="">
			<div class="social-share-button social-share-button-google">
				<div aria-hidden="true" class="social-share-icon">
		...
		<a class="social-share-link" href="https://pinterest.com/pin/create/button/?url=<?php echo urlencode(get_permalink()); ?>&amp;media=<?php echo urlencode(get_permalink()); ?>&amp;description=<?php echo urlencode(get_the_title()); ?>" target="_blank" rel="noreferrer noopener" aria-label="">
			<div class="social-share-button social-share-button-pinterest">
				<div aria-hidden="true" class="social-share-icon">
